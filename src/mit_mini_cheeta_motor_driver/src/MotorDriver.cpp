...
motor_driver::MotorType stringToMotorType(const std::string& motor_type_str) {
  // TODO: This function seemed like a nessesary evil at the time. I would be elated if it was destroyed.
  // AK80_6_V1,
  // AK80_6_V1p1,
  // AK80_6_V2,
  // AK80_9_V1p1,
  ...
  // GIM8108
    ...
    else if (motor_type_str == "AK80_6_V1") {
        return motor_driver::MotorType::AK80_6_V1;
    }
    else if (motor_type_str == "AK80_6_V1p1") {
        return motor_driver::MotorType::AK80_6_V1p1;
    }
    else if (motor_type_str == "AK80_6_V2") {
        return motor_driver::MotorType::AK80_6_V2;
    }
    else if (motor_type_str == "AK70_10V1p1") {
        return motor_driver::MotorType::AK70_10V1p1;
    }
    else if (motor_type_str == "AK10_9_V1p1") {
        return motor_driver::MotorType::AK10_9_V1p1;
    }
    // Add more motor types as needed
    else {
        std::cout << "Unknown motor type: %s. Defaulting to GIM8108"<< motor_type_str.c_str()<< std::endl;
        return motor_driver::MotorType::GIM8108;
    }
}
