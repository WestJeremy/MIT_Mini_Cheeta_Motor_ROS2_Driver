...
hardware_interface::CallbackReturn CANMotor::on_init(const hardware_interface::HardwareInfo& info){
    ...
    // Motor type parse from URDF and enum conversion
    motor_type_str = info.hardware_parameters.at("motor_type").c_str();
    motor_type = motor_driver::stringToMotorType(motor_type_str);
